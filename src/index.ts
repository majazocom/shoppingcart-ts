...
function updateCart(): void {
  const cartAmountElem: HTMLElement | null = document.getElementById("productsInCart");
  ...
  productButtons.forEach((productButton) => {
    productButton.addEventListener('click', (event: Event) => {
      ...
      if (clickedElement.parentElement) {
        const productTitle: string | null = clickedElement.parentElement.getAttribute('data-product');
